...
vfr.py -i audio.flac -vf tc1-cfr.txt test.avs --test > result-tc1-cfr-%1.txt
vfr.py -i audio.flac -vf tc2-cfr.txt test.avs --test > result-tc2-cfr-%1.txt
vfr.py -i audio.flac -vf tc1-vfr.txt test.avs --test > result-tc1-vfr-%1.txt
vfr.py -i audio.flac -vf tc2-vfr.txt test.avs --test > result-tc2-vfr-%1.txt
@echo off
